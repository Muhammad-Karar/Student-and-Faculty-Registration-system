...
public class EmployeeGui extends JFrame implements ActionListener {
    ...
    EmployeeGui() {
        ...
        t.setBounds(80, 85, 120, 20);
        name.setBounds(20, 85, 50, 20);

        cnic.setBounds(230, 80, 100, 20);
        t2.setBounds(300, 80, 140, 20);
        address.setBounds(15, 140, 100, 20);
        t4.setBounds(80, 140, 120, 20);
        phno.setBounds(230, 140, 100, 20);
        t5.setBounds(300, 140, 140, 20);
        emil.setBounds(20, 190, 100, 20);
        t6.setBounds(80, 190, 120, 20);
        date.setBounds(230, 190, 100, 20);
        t7.setBounds(330, 190, 110, 20);
        age.setBounds(470, 190, 50, 20);
        t8.setBounds(500, 190, 50, 20);
        clas.setBounds(20, 330, 100, 20);
        t9.setBounds(120, 330, 100, 20);
        section.setBounds(230, 330, 100, 20);
        t10.setBounds(300, 330, 100, 20);
        cgpa.setBounds(20, 450, 100, 20);
        t11.setBounds(120, 450, 100, 20);
        quiz.setBounds(20, 360, 120, 20);
        t12.setBounds(120, 360, 100, 20);
        ass.setBounds(230, 360, 120, 20);
        t13.setBounds(300, 360, 100, 20);
        mid.setBounds(20, 390, 100, 20);
        t14.setBounds(120, 390, 100, 20);
        fin.setBounds(230, 390, 80, 20);
        t15.setBounds(300, 390, 100, 20);
        fyp.setBounds(20, 420, 100, 20);
        t16.setBounds(120, 420, 100, 20);
        ch.setBounds(220, 420, 100, 20);
        t17.setBounds(300, 420, 100, 20);
        prj.setBounds(20, 480, 100, 20);
        t18.setBounds(120, 480, 100, 20);
        std.setBounds(220, 450, 100, 20);
        t19.setBounds(300, 450, 100, 20);
        submit = new JButton();
        ...
        search.setBounds(180, 550, 110, 20);
        next = new JButton("Next");
        next.setBounds(300, 550, 110, 20);
        this.add(next);
        this.add(search);
        delet.setBounds(420, 550, 110, 20);
        this.add(delet);
